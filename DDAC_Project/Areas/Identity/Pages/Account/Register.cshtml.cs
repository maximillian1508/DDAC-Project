...
namespace DDAC_Project.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        private DDAC_ProjectUser CreateUser()
        {
            try
            {
                return Activator.CreateInstance<DDAC_ProjectUser>();
            }
            catch
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(DDAC_ProjectUser)}'. " +
                    $"Ensure that '{nameof(DDAC_ProjectUser)}' is not an abstract class and has a parameterless constructor, or alternatively " +
        ...
        private IUserEmailStore<DDAC_ProjectUser> GetEmailStore()
        {
            ...
            return (IUserEmailStore<DDAC_ProjectUser>)_userStore;
        }
    }
}
